...
function getItemByRegion(regiao, index) {
  ...
  regiao.estados.forEach(function (estado, index) {
    ...
    estado.lista.forEach(function (curso, index) {
      _html +=
        '<li><span class="campo">Nome: </span><span class="valor">' +
        curso.nome +
        "</span><li>";
      _html +=
        '<li><span class="campo">Instituição: </span><span class="valor">' +
        curso.instituicao +
        "</span><li>";
      _html +=
        '<li><span class="campo">Endereço: </span><span class="valor">' +
        curso.endereco +
        "</span><li>";
      _html +=
        '<li><span class="campo">Contato: </span><span class="valor">' +
        curso.telefone +
        "</span><li>";
      _html +=
        '<li><span class="campo">Site: </span><span class="valor">' +
        curso.site +
        "</span><li>";
      _html +=
        '<li><span class="campo">Email: </span><span class="valor">' +
        curso.email +
        "</span><li>";
      _html +=
        '<li><span class="campo">Coordenação: </span><span class="valor">' +
        curso.coordenacao +
        "</span><li>";
...
function modalVideo(modalToShow, openButton, closeButton) {
  ...
  openVi.onclick = function () {
    modalVi.style.display = "block";
    return false;
  };
  if (closeVi != null) {
    closeVi.onclick = function () {
